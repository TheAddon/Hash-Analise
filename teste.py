...
logo='''   
    		...
    		| ANALISE HASH | VICTOR PADOVAN | TESTE DE INVASÃO|
        	|______________|________________|_________________|		       
      									                                				
    	             |Hash Analise, permite que voce consiga 
    	            descobrir a verdadeira sigla de uma Hash|
    	
    	
    	   - Canal Pesadelo do Sistema | pesadelodosistemacontato@gmail.com '''
...
while True:
   ...
   -------------------------------------------------------------------------"""
    ...
    if len(jerar)==0:
        print ""
        print " Sinto muito, masss!!! Nao encontrei nenhum resultado p/ essa Hash "
    elif len(jerar)>2:
        jerar.sort()
        print ""
        print "Acredito que essa Hashs seja uma :"
        print "[+] ",algorithms[jerar[0]]
        print "[+] ",algorithms[jerar[1]]
        print ""
        print "Passou longe de ser algumas dessas Hashs abaixo:"
