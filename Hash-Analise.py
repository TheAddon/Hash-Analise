...
logo='''   #########################################################################
  ...
  #		Com essa ferramenta, voce conseguira descobrir qual categoria           	#
  #						pertence a uma Hash 										#
  #										- pesadelodosistemacontato@gmail.com		#
  ###################################################################################
...
while True:
    ...
    print """
   -------------------------------------------------------------------------"""
    hash = raw_input(" Digite aqui sua HASH: ")
    ...
    if len(jerar)==0:
        print ""
        print " Sinto muito, masss!!! Nao encontrei nada com essa pesquisa."
    elif len(jerar)>2:
        jerar.sort()
        print ""
